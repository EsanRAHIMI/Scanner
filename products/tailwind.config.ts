...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Semantic theme tokens (CSS vars in globals.css; switch on `.dark`).
        // Use these for new/converted UI: bg-background, text-foreground,
        // bg-card, text-muted-foreground, border-border, border-input, etc.
